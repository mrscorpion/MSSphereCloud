...
static MSPoint MSPointMakeRotation(MSPoint point, MSPoint direction, CGFloat angle) {
...
//    DBMatrix pointM = DBMatrixMakeFromArray(1, 4, *temp2);
    ...
    MSPoint resultPoint = MSPointMake(result.matrix[0][0], result.matrix[0][1], result.matrix[0][2]);
